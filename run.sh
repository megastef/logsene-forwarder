...
if [ $1 == "service" ]; then
	...
	export SYSLOG_FILTERS="filter://regex://syslog_no_prio filter://regex://syslog?only_type=syslog filter://syslog_pri://?only_type=syslog filter://geoip://host filter://reverse_dns://host"
